              ...
              <jet-dropdown align="right" width="48">
                ...
                <template #content>
                  ...
                  <jet-dropdown-link :href="route('profile.show')">
                    Akun
                    <jet-user-type-chip :type="$page.user.type" />
                  </jet-dropdown-link>

                  <jet-dropdown-link :href="route('profile.show-detail')">
                    Profil
                  </jet-dropdown-link>

                  <jet-responsive-nav-link :href="route('password.show')">
                    Ubah Kata Sandi
                  ...
                  <form @submit.prevent="logout">
                    <jet-dropdown-link as="button"> Keluar </jet-dropdown-link>
                  </form>
                </template>
              </jet-dropdown>
            </div>
      ...
      >
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
          ...
          <div class="mt-3 space-y-1">
            ...
            <jet-responsive-nav-link
              :href="route('profile.show-detail')"
              :active="$page.currentRouteName == 'profile.show-detail'"
            >
              Profil
            </jet-responsive-nav-link>
            ...
            <jet-responsive-nav-link
              ...
              :active="$page.currentRouteName == 'password.show'"
            >
              Ubah Kata Sandi
            </jet-responsive-nav-link>
...
import JetUserTypeChip from "./../Jetstream/UserTypeChip";
