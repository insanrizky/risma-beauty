        ...
        <div class="overflow-hidden sm:rounded-lg">
          <div class="max-w-sm w-full lg:max-w-full lg:flex">
            <div
              v-for="x in [1, 2, 3]"
              :key="x"
              class="bg-white mb-6 md:ml-6 border-t-2 border-orange-500 rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal"
            >
              <div class="flex justify-between mb-4">
                <user-status :status="'SEDANG DIVERIFIKASI'" class="text-sm" />
                <button
                  @click="alert()"
			...
			S232.05,306,204,306z"
              ...
              <div class="flex items-center mb-4">
                ...
                <div class="text-sm">
                  ...
                  <p class="text-gray-600">jo@reinink.com</p>
                </div>
              </div>
              <div class="mb-4">
                <div class="flex">
                  ...
                  <p class="ml-2 text-gray-700 text-base">087741112312</p>
                </div>
                <div class="flex">
                  <svg
                    version="1.1"
			...
			C550.801,120.485,539.84,109.524,526.32,109.524z"
                ...
                <p class="mt-3 text-gray-700 text-base">
                  Jl. Situbondo No. 99 RT. 14/01 Daan Mogot, Cawang, Lebak, Banten
                </p>
              </div>
